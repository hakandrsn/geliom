...
export default function SearchUserScreen() {
  ...
  const handleSendInvite = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Davet Gönderildi',
        `${foundUser.display_name || foundUser.custom_user_id} kullanıcısına ${selectedGroup.name} grubuna katılma daveti gönderildi.`,
        [
          {
            text: 'Tamam',
            onPress: () => {
  ...
  return (
    <BaseLayout
      ...
      header={{
        ...
        title: <Typography variant="h5" color={colors.text}>Kullanıcı Ara</Typography>,
      ...
      <KeyboardAwareView contentContainerStyle={styles.contentContainer} keyboardVerticalOffset={headerHeight}>
        <View style={styles.headerSection}>
          ...
          <Typography variant="body" color={colors.secondaryText} style={{ textAlign: 'center' }}>
            Kullanıcının custom ID'sini girerek arama yapın ve gruba davet gönderin
          </Typography>
        </View>
