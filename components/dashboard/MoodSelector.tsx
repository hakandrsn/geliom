...
function MoodSelector({ groupId, currentMoodId, onAddPress }: MoodSelectorProps) {
    ...
    // LOCAL STATE
    const [activeId, setActiveId] = useState<number | undefined>(currentMoodId);
    ...
    const handleMoodSelect = useCallback((mood: any) => {
        if (!user) return;
    ...
    const allItems = useMemo(() => {
        ...
        return [...sorted, { id: -1, text: 'Ekle', emoji: '➕', group_id: null }];
    }, [allMoods]);
