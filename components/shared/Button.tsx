...
export default function Button({
  ...
  const defaultTextVariant = size === "large" ? "h6" : "bodySmall";
  ...
  const content = (
    <View
      style={[styles.contentWrapper, size === "small" && styles.contentPadding]}
    >
        ...
        <LinearGradient
          colors={
            isEffectivelyDisabled
              ...
              : (colors.linearGradient as [string, string])
          }
        ...
        >
          <View
            style={[
              ...
              size === "small"
                ? styles.smallInnerRadius
                : styles.largeInnerRadius,
            ]}
          >
            {content}
          </View>
        ...
        <LinearGradient
          ...
          style={[
            styles.fullWidthHeight,
            {
              borderRadius:
                size === "large"
                  ? styles.largeContainer.borderRadius
                  : styles.smallContainer.borderRadius,
            },
          ]}
        >
          {content}
